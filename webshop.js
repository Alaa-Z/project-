...
* ändra språket till engelska for några element
* ändra popup-meddelandet style som visas och försvinner efter 1500ms
...
var counter= 0;
var productsNumber = document.querySelector(".num-cart-product");
...
function showSmallBasket() {
    if (document.getElementById("small-basket")) {
        ...
        if (basketItems.length > 0) {
            ...
            smallBasketEl.innerHTML = numOfItems + "st ";
...
function showCheckout() {
    if (document.getElementById("checkout")) {
        ...
        if (basketItems.length > 0) {
            ...
            // Tomt i listan
            checkoutEl.innerHTML = "<tr style='color:red'><td colspan='5'>The shopping cart is empty</td></tr>";
        }
    }
}
